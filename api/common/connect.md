...
{% swagger baseUrl="https://{APIGWAddr}/v1/common/member" path="/register/search" method="post" summary="/register/search" %}
{% swagger-description %}
...
{% swagger baseUrl="https://{APIGWAddr}/v1/common/member" path="/consent/search" method="post" summary="/consent/search" %}
{% swagger-description %}
...
#### &#x20;Content-Type | `Application/json` <a href="#content-type-or-application-json-charset-utf-8" id="content-type-or-application-json-charset-utf-8"></a>
...
## 테스트용 목업데이터 <a href="#virtualaccount" id="virtualaccount"></a>

* 샌드박스에서 계좌서비스를 테스트 하기 위해서는 미리 제공되는  [계좌서비스 테스트용 ­ 목업 데이터 V2 (PDF)](https://developers.koscom.co.kr/resources/documentation/Account\_MockupData\_V2.pdf) 를 이용하여, 서비스 연동 조회 테스트를 제공한다.
