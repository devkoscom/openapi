...
KONEX시장의 종목 리스트, 종목 마스터 등 종가 정보를 제공한다.
...
## KONEX 주식 종목 리스트 API  <a href="#api" id="api"></a>

* 제공시간 : AM 06:30

{% swagger baseUrl="https://{APIGWAddr}/v3/market/closed/konex" path="/lists" method="get" summary="/v3/market/closed/konex/lists" %}
{% swagger-description %}
종목리스트
